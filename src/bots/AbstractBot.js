import {Chunky, Seeker, Shield, Speedy, Tank} from "@/seekerTypes";
export default class AbstractBot {
    constructor(player) {
        this.player = player;
    ...
    dist(v1, v2) {
        ...
        connect = this.limitWithin(connect, -this.p5.width/2, this.p5.width/2, -this.p5.height/2, this.p5.height/2, 2);
