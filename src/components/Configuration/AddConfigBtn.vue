            ...
            <v-container>
              ...
              <v-card-text>
                ...
                <v-container v-if="config === 'co2'">
                  <v-slider v-model="configData['low-threshold']" label="lower Threshold" min="400" max="3000" thumb-label></v-slider>
                  <v-slider v-model="configData['high-threshold']" thumb-label label="critical Threshold" :min="configData['low-threshold']" max="3000"></v-slider>
                </v-container>
                <v-container v-if="config === 'temperature'">
                  <v-slider v-model="configData['cold-threshold']" thumb-label label="too cold Threshold" :min="0" max="30"></v-slider>
                  <v-slider v-model="configData['hot-threshold']" thumb-label label="too hot Threshold" :min="configData['cold-threshold']" max="30"></v-slider>
                </v-container>
