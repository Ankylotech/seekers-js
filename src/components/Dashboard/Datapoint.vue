<template>
  <div>
    ...
    <v-card-text class="orange--text" color="orange" v-else-if="isOrange">{{ name.toUpperCase() }} : {{ value }}
    </v-card-text>
    <v-card-text v-else>{{ name.charAt(0).toUpperCase() + name.slice(1) }} : {{ value }}</v-card-text>
  </div>
</template>
